...
`<vanilla-grid id="` + CONSTS.SAMPLE_GRID_IDS_INTRO[0] + `" checkedValue="T" uncheckedValue="F">
...
`<vanilla-grid id="` + CONSTS.SAMPLE_GRID_IDS_STARTED[1] + `">
    <v-col id="dept" header="Click the Sigma button to the left of the header;filter1(mask);dept " dataType="mask" format="AAA99" width="100"></v-col>
    <v-col id="f_nm" header=";filter2(text);first name" dataType="text" width="120" align="center"></v-col>
    <v-col id="l_nm" header=";filter3(text);last name" dataType="text" width="120" align="center"></v-col>
    <v-col id="d_o_j" header=";filter4(month);DOJ" dataType="month" width="120"></v-col>
    <v-col id="e_id" header="Please double click;sort1(text);Employee ID" dataType="text" width="120" align="center"></v-col>
...
`<vanilla-grid id="` + CONSTS.SAMPLE_GRID_IDS_STARTED[2] + `" nullValue="-">
